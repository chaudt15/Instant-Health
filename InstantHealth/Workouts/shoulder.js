...
_generateShoulder(){
  ...
  fetch("http://45.55.168.202:3300/lifts/shoulder", {method: "GET"})
        ...
        <View style={styles.topBannerView}>
                ...
                <View style={styles.uiBar}></View>
                  ...
                  <View style={styles.welcomeBar}>
                    <Text style={{fontFamily: 'AvenirNext-Regular', fontSize: 24}}>Shoulder Workout Generator</Text>
                  </View>
                </View>
              ...
              <View style={styles.lowView}>
                ...
                <View style={styles.generate}>
                  <TouchableHighlight onPress={this._generateShoulder.bind(this)}>
                    <Text style={{textAlign: 'center', fontFamily: 'Avenir-Light', fontSize: 20}}>Click Here To Generate Shoulder Workout</Text>
                  </TouchableHighlight>
                </View>
              </View>
