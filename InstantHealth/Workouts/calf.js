...
export default class Calf extends Component {
...
_generateCalf(){
  ...
  fetch("http://45.55.168.202:3300/lifts/calf", {method: "GET"})
        ...
        <View style={styles.topBannerView}>
                ...
                <View style={styles.uiBar}></View>
                  ...
                  <View style={styles.welcomeBar}>
                    <Text style={{fontFamily: 'AvenirNext-Regular', fontSize: 24}}>Calf Workout Generator</Text>
                  </View>
                </View>
              ...
              <View style={styles.lowView}>
                ...
                <View style={styles.generate}>
                  <TouchableHighlight onPress={this._generateCalf.bind(this)}>
                    <Text style={{textAlign: 'center', fontFamily: 'Avenir-Light', fontSize: 20}}>Click Here To Generate Calf Workout</Text>
                  </TouchableHighlight>
                </View>
              </View>
