...
export default class Hamstring extends Component {
...
_generateHamstring(){
  ...
  fetch("http://45.55.168.202:3300/lifts/hamstring", {method: "GET"})
        ...
        <View style={styles.topBannerView}>
                ...
                <View style={styles.uiBar}></View>
                  ...
                  <View style={styles.welcomeBar}>
                    <Text style={{fontFamily: 'AvenirNext-Regular', fontSize: 24}}>Hamstring Workout Generator</Text>
                  </View>
                </View>
              ...
              <View style={styles.lowView}>
                ...
                <View style={styles.generate}>
                  <TouchableHighlight onPress={this._generateHamstring.bind(this)}>
                    <Text style={{textAlign: 'center', fontFamily: 'Avenir-Light', fontSize: 20}}>Click Here To Generate Hamstring Workout</Text>
                  </TouchableHighlight>
                </View>
              </View>
